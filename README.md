...
설치와 빌드가 필요 없는 정적 웹 게임입니다. 기본적으로 25개 샘플 문제로 동작하며, Firebase Firestore를 연결하면 문제를 온라인에서 관리할 수 있습니다. 인물 사진 힌트는 위키백과 공개 썸네일을 인터넷으로 불러오며, 사진을 열면 해당 문제의 정답 점수는 10점 대신 8점입니다.
